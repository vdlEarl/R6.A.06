...
var o, s, l, c, f, h, v, m = t && t.ownerDocument, T = t ? t.nodeType : 9; if ( r = r || [], "string" != typeof e || !e || 1 !== T && 9 !== T && 11 !== T ) {
return r;
...
var n, r = 0, i = this.length, o = [], a = "string" != typeof e && w( e ); if ( !D.test( e ) ) {
for ( ;r < i; r++ ) {
...
var t = w.event.fix( e ), n, r, i, o, a, s, u = new Array( arguments.length ), l = ( J.get( this, "events" ) || {} )[ t.type ] || [], c = w.event.special[ t.type ] || {}; for ( u[ 0 ] = t, n = 1; n < arguments.length; n++ ) {
u[ n ] = arguments[ n ];
...
t = a.apply( [], t ); var i, o, s, u, l, c, f = 0, p = e.length, d = p - 1, y = t[ 0 ], v = g( y ); if ( v || p > 1 && "string" == typeof y && !h.checkClone && je.test( y ) ) {
...
var r, i, o, a, s = e.cloneNode( !0 ), u = w.contains( e.ownerDocument, e ); if ( !( h.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || w.isXMLDoc( e ) ) ) {
...
if ( e in Ye ) {
return e;
} var t = e[ 0 ].toUpperCase() + e.slice( 1 ), n = Ge.length; while ( n-- ) {
if ( ( e = Ge[ n ] + t ) in Ye ) {
return e;
}
}
...
var i, o, a, s = G( t ), u = Xe.test( t ), l = e.style; if ( u || ( t = Je( s ) ), a = w.cssHooks[ t ] || w.cssHooks[ s ], void 0 === n ) {
...
var t = !0, i = null != e && e + "queueHooks", o = w.timers, a = J.get( this ); if ( i ) {
a[ i ] && a[ i ].stop && r( a[ i ] );
} else {
for ( i in a ) {
...
var t, n = J.get( this ), r = n[ e + "queue" ], i = n[ e + "queueHooks" ], o = w.timers, a = r ? r.length : 0; for ( n.finish = !0, w.queue( this, e, [] ), i && i.stop && i.stop.call( this, !0 ), t = o.length; t--; ) {
...
var e, t = 0, n = w.timers; for ( nt = Date.now(); t < n.length; t++ ) {
...
var n, r = 0, i = t && t.match( M ); if ( i && 1 === e.nodeType ) {
while ( n = i[ r++ ] ) {
e.removeAttribute( n );
}
}
...
return function( t, n ) {
"string" != typeof t && ( n = t, t = "*" ); var r, i = 0, o = t.toLowerCase().match( M ) || []; if ( g( n ) ) {
while ( r = o[ i++ ] ) {
...
var n, r, i = w.ajaxSettings.flatOptions || {}; for ( n in t ) {
...
var n, r; if ( h.cors || Gt && !t.crossDomain ) {
...
var i, o, a, s = !1 !== t.jsonp && ( Qt.test( t.url ) ? "url" : "string" == typeof t.data && 0 === ( t.contentType || "" ).indexOf( "application/x-www-form-urlencoded" ) && Qt.test( t.data ) && "data" ); if ( s || "jsonp" === t.dataTypes[ 0 ] ) {
